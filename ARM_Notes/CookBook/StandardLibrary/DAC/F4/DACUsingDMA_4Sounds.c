...
/**
  ******************************************************************************
  * @file    DAC/DAC_SignalGeneration/main.c
...
void DAC_Ch2_EscalatorConfig(void);
void DAC_Ch2_SineWaveConfig(void);
void DAC_Ch2_NoiseConfig(void);
void DAC_Ch2_TriangleConfig(void);
void DAC_Ch2_Silence(void);
void Flip_Led(uint16_t ledIndex);


void Flip_Led(uint16_t ledIndex)
{
    GPIO_ResetBits(GPIOD, GPIO_Pin_12|GPIO_Pin_13|GPIO_Pin_14|GPIO_Pin_15);
    GPIO_SetBits(GPIOD, ledIndex);
}
...
int main(void)
{
  ...
  while (1)
  {
	  Flip_Led(GPIO_Pin_12);
	  DAC_Ch2_SineWaveConfig();
	  Delay(0x8FFFFF);

	  Flip_Led(GPIO_Pin_13);
	  DAC_Ch2_TriangleConfig();
      Delay(0x8FFFFF);

	  //DAC_Ch2_EscalatorConfig();

      Flip_Led(GPIO_Pin_14);
      DAC_Ch2_NoiseConfig();
//	  DAC_Ch2_EscalatorConfig();
	  //DAC_Ch2_Silence();
      Delay(0x8FFFFF);
...
//  DMA_InitStructure.DMA_Memory0BaseAddr = (uint32_t)&Escalator8bit;
  DMA_InitStructure.DMA_Memory0BaseAddr = (uint32_t)&Squares12bit;
  DMA_InitStructure.DMA_BufferSize = 32;
