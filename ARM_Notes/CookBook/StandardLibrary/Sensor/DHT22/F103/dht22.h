/******************************************************************************
  * @title        DHT22.h
  * @Description  Driver code (Header) to inteface with the temperature/Humidity
  *               sensor named DHT22. This drive assume that the pin B0 is connected
  *               to the sensor, but whit can be changed by changing the pin value (DHT22_GPIO_PIN)
  *               in this header file.
  *
  ********************************************************************************/
