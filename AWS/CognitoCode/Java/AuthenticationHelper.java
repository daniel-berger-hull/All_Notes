...
class AuthenticationHelper {
    ...
    private InitiateAuthRequest initiateUserSrpAuthRequest(String username) {
        ...
        initiateAuthRequest.addAuthParametersEntry("SECRET_HASH", this.getSecretHash(username, this.clientId, this.secretKey));
    ...
    private RespondToAuthChallengeRequest userSrpAuthRequest(InitiateAuthResult challenge,
        ...
        srpAuthResponses.put("SECRET_HASH", getSecretHash(usernameInternal, this.clientId, this.secretKey));
